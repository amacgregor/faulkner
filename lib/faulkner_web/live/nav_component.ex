defmodule FaulknerWeb.NavComponent do
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                <%= link "Assignments", to: Routes.assignment_index_path(@socket, :index) , class: "bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium"%>
              </div>
            </div>
          </div>
          <div class="hidden md:block">
